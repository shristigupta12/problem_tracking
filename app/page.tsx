  ...
  return (
      <PageContainer className='flex flex-col gap-11'>
        ...
        <ViewContainer className="flex items-center justify-center w-[1250px]">
          <DataTable columns={columns} data={tableData} className=" w-full border rounded shadow-md shadow-neutral-200 dark:shadow-neutral-700 dark:border-neutral-600 bg-white" />
        </ViewContainer>
      </PageContainer>
  )
}
